...
MEXC_CONTRACT_API_BASE_URL = "https://contract.mexc.com"
...
DEFAULT_GLOBAL_FLAG_CHECKER_JOB_INTERVAL_SECONDS = 60  # 1 minute
...
# Auto-Entry Trader
AUTO_ENTRY_TRADER_MINIMAL_AMOUNT_TO_INVEST = 10.0
