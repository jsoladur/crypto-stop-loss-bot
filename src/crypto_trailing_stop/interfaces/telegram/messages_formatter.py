...
class MessagesFormatter(metaclass=SingletonMeta):
    ...
    def format_buy_sell_signals_config_message(self, item: BuySellSignalsConfigItem) -> str:
        return (
            ...
            f"🔊 Min Volume Threshold = {html.code(item.min_volume_threshold) if item.enable_buy_volume_filter else html.italic('(n/a)')}\n"  # noqa: E501
            f"🔇 Max Volume Threshold = {html.code(item.max_volume_threshold) if item.enable_buy_volume_filter else html.italic('(n/a)')}\n"  # noqa: E501
