                    ...
                    async with await self._bit2me_remote_service.get_http_client() as client:
                        ...
                        if amount_to_invest > AUTO_ENTRY_TRADER_MINIMAL_AMOUNT_TO_INVEST:
                            ...
                            await self._stop_loss_percent_service.save_or_update(
                                StopLossPercentItem(
                                    symbol=crypto_currency, value=guard_metrics.suggested_stop_loss_percent_value
                                )
                            )

                            # XXX: Re-enable Limit Sell Order Guard, once stop loss is setup!
