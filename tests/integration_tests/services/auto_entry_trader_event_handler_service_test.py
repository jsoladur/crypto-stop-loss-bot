...
from tests.helpers.market_config_utils import get_bit2me_market_config_by_symbol
...
def _prepare_httpserver_mock(
    ...
    *,
    ...
    trading_market_config = get_bit2me_market_config_by_symbol(symbol=symbol)
